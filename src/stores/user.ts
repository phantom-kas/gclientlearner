...
export const useUserStore = defineStore("useUserStore", () => {
  const getRToken = ref(useLocalStorage("rtoken", null as string | null));
  const img_root_dir = ref(useLocalStorage('img_root_dir', null as string | null))
  ...
  const getAToken = ref(useLocalStorage("atoken", null as string | null));
  const removeAtkn = () => {
    getAToken.value = "";
  };
